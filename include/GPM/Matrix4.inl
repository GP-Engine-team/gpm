...
{
    return {.0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f, .0f};
}

inline constexpr Matrix4 Matrix4::identity() noexcept
{
    return {1.f, .0f, .0f, .0f, .0f, 1.f, .0f, .0f, .0f, .0f, 1.f, .0f, .0f, .0f, .0f, 1.f};
}

/* =================== Constructors =================== */
inline constexpr Matrix4::Matrix4(const f32 e0, const f32 e1, const f32 e2, const f32 e3, const f32 e4, const f32 e5,
                                  const f32 e6, const f32 e7, const f32 e8, const f32 e9, const f32 e10, const f32 e11,
                                  const f32 e12, const f32 e13, const f32 e14, const f32 e15) noexcept
    : e{e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15}
{
}

inline constexpr Matrix4::Matrix4(const Vec4& c0, const Vec4& c1, const Vec4& c2, const Vec4& c3) noexcept
    : c{c0, c1, c2, c3}
{
}
...
{
    // Repeated values
    const f32 a22a33{e[5] * e[10]}, a23a34{e[9] * e[14]}, a24a32{e[13] * e[6]}, a24a33{e[13] * e[10]},
        a23a32{e[9] * e[6]}, a22a34{e[5] * e[14]}, a33a42{e[10] * e[7]}, a32a44{e[6] * e[15]}, a34a43{e[14] * e[11]},
        a33a44{e[10] * e[15]}, a32a42{e[14] * e[7]}, a32a43{e[6] * e[11]}, a12a23{e[4] * e[9]}, a13a24{e[8] * e[13]},
        a14a22{e[12] * e[5]}, a14a23{e[12] * e[9]}, a13a22{e[8] * e[5]}, a12a24{e[4] * e[13]}, a31a44{e[2] * e[15]},
        a31a43{e[2] * e[11]}, a13a21{e[8] * e[1]}, a14a21{e[12] * e[1]}, a31a42{e[2] * e[7]}, a11a24{e[0] * e[13]},
        a12a21{e[4] * e[1]}, a34a41{e[14] * e[3]}, a33a41{e[10] * e[3]}, a32a41{e[6] * e[3]}, a11a23{e[0] * e[9]},
        a11a22{e[0] * e[5]};

    return {
        (a22a33 * e[15]) + (a23a34 * e[7]) + (a24a32 * e[11]) - (a24a33 * e[7]) - (a23a32 * e[15]) - (a22a34 * e[11]),
        (e[12] * a33a42) + (e[8] * a32a44) + (e[4] * a34a43) - (e[4] * a33a44) - (e[8] * a32a42) - (e[12] * a32a43),
        (a12a23 * e[15]) + (a13a24 * e[7]) + (a14a22 * e[11]) - (a14a23 * e[7]) - (a13a22 * e[15]) - (a12a24 * e[11]),
        (e[12] * a23a32) + (e[8] * a22a34) + (e[4] * a24a33) - (e[4] * a23a34) - (e[8] * a24a32) - (e[12] * a22a33),
        (a24a33 * e[3]) + (e[9] * a31a44) + (e[1] * a34a43) - (e[1] * a33a44) - (a23a34 * e[3]) - (e[13] * a31a43),
        (e[0] * a33a44) + (e[8] * a34a41) + (e[12] * a31a43) - (e[12] * a33a41) - (e[8] * a31a44) - (e[0] * a34a43),
        (a14a23 * e[3]) + (a13a21 * e[15]) + (a11a24 * e[11]) - (a11a23 * e[15]) - (a13a24 * e[3]) - (a14a21 * e[11]),
        (e[0] * a23a34) + (a13a24 * e[2]) + (a14a21 * e[10]) - (a14a23 * e[2]) - (a13a21 * e[14]) - (e[0] * a24a33),
        (e[1] * a32a44) + (a22a34 * e[3]) + (e[13] * a31a42) - (a24a32 * e[3]) - (e[5] * a31a44) - (e[1] * a32a42),
        (e[12] * a32a41) + (e[4] * a31a44) + (e[0] * a32a42) - (e[0] * a32a44) - (e[4] * a34a41) - (e[12] * a31a42),
        (a11a22 * e[15]) + (a12a24 * e[3]) + (a14a21 * e[7]) - (a14a22 * e[3]) - (a12a21 * e[15]) - (a11a24 * e[7]),
        (a14a22 * e[2]) + (a12a21 * e[14]) + (e[0] * a24a32) - (e[0] * a22a34) - (a12a24 * e[2]) - (a14a21 * e[6]),
        (a23a32 * e[3]) + (e[5] * a31a43) + (e[1] * a33a42) - (e[1] * a32a43) - (a22a33 * e[3]) - (e[9] * a31a42),
        (e[0] * a32a43) + (e[4] * a33a41) + (e[8] * a31a42) - (e[8] * a32a41) - (e[4] * a31a43) - (e[0] * a33a42),
        (a13a22 * e[3]) + (a12a21 * e[11]) + (a11a23 * e[7]) - (a11a22 * e[11]) - (a12a23 * e[3]) - (a13a21 * e[7]),
        (e[0] * a22a33) + (a12a23 * e[2]) + (a13a21 * e[6]) - (a13a22 * e[2]) - (a12a21 * e[10]) - (e[0] * a23a32)};
}
...
{
    const f32 det1{(e[10] * e[15]) - (e[14] * e[11])}, det2{(e[2] * e[15]) - (e[14] * e[3])},
        det3{(e[6] * e[15]) - (e[14] * e[7])}, det4{(e[6] * e[11]) - (e[10] * e[7])},
        det5{(e[2] * e[11]) - (e[10] * e[3])}, det6{(e[2] * e[7]) - (e[6] * e[3])};
...
{
    return {(e[0] * v.xyz.x) + (e[4] * v.xyz.y) + (e[8] * v.xyz.z) + (e[12] * v.w),
...
{
    return {(e[0] * m.e[0]) + (e[4] * m.e[1]) + (e[8] * m.e[2]) + (e[12] * m.e[3]),
...
inline constexpr const float* Matrix4::operator[](unsigned int indexLine) const noexcept
{
    return (&e[indexLine * 4]);
}

inline constexpr float* Matrix4::operator[](unsigned int indexLine) noexcept
{
    return (&e[indexLine * 4]);
}
